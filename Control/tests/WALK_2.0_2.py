...
while i<1000:
	...
	#time.sleep(1/240)
	#poses_e.append(pos42)
	#poses_k.append(pos41)
	i += 1
	#ii.append(i)


#plt.plot(ii,poses_e, color="red", label="Elbow")
#plt.plot(ii,poses_k, color="blue", label="Knee")
#plt.legend()
#plt.title("Right Back Leg real positions")
#plt.savefig("RB_LEG.png")