...
def genetic(e, n, k):
    ...
    for i in range(e):
        ...
        # Create new population with roulette wheel selection
        new_pop = roulette_wheel(fit_pop[:k])
...
if __name__ == "__main__":
    ...
    values, score, scores, epochs, standard_errors, st_epochs, st_scores = genetic(1000, 100, 20)
