...
robotId = p.loadURDF("../../robot/PinkPanther/urdf/PinkPanther_max_limits.urdf", robotStartPos, robotStartOrientation)
...
for i in range (10000):
    ...
    if i <= m.pi*50:
        ...
        shoulders_one = 3*m.sin(i*0.02+1)
    else:
        shoulders_one = 0.50
    ...
    """
        ...
        shoulders_two = -1*m.sin(i*0.02)
    elif i <= m.pi*100:
        shoulders_two = -2*m.sin(i*0.02)"""
    ...
    """
        ...
        knees_two = -1*m.sin(i*0.02)
    elif i <= m.pi*100:
        knees_two = -2*m.sin(i*0.02)"""
